    ...
    <header class="py-5" style="background-color: #000; font-family: 'Scandia'; color: #fff;">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0 product-card" style="animation-delay: 0.5s">Tersedia Produk
                    Digital Yang Saya Jual</p>
            </div>
        </div>
    </header>
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Cari produk..." name="search" id="searchInput"
                        onkeyup="filterProducts()" style="border: 1px solid #FF3B30; outline: none; border-radius: 0;">
                </div>
                <div class="mt-3">
                    <div class="d-flex justify-content-center flex-wrap gap-2 product-card"
                        ...
                        <span class="rzw-btn-border product-card" style="animation-delay: 1.0s">
                            <a href="#" class="btn rzw-btn rzw-bg-laravel-light"
                                data-category="kendaraan">Kendaraan</a>
                        </span>
